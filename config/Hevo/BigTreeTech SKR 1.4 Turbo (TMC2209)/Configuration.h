...
#define STRING_CONFIG_H_AUTHOR "(techolutions, Hevo - SKR1.4T)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.3, 8.5, -0.4 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 135
