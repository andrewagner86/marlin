...
#define STRING_CONFIG_H_AUTHOR "(techolutions, Anet A8 - ANET1.0)" // Who made the changes.
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 149.51
  #define XY_DIAG_BD 149.88
  #define XY_SIDE_AD 106.60
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { -20, 40, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { -10, 80, (Z_MIN_POS + 1) } }
  ...
  #define NOZZLE_CLEAN_CIRCLE_MIDDLE { { -15, 60, (Z_MIN_POS + 1) } }
